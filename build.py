...
file = "temperature_converters-"
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/temperature_converters/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/temperature_converters/archive/master.zip", tmp)
    file += "master"
